...
<a name="s1" id="s1"></a>
<h3>動画の削除</h3>
<p class="lefttxt1">削除する動画:「<?php print($row['movie_title']) ?>」この動画を本当に削除しますか？
<?php print($row['movie_title']) ?>
<br><a href="delete_comp.php?number=<?php print($row['id']) ?>">はい</a>/<a href="index.php">いいえ</a>
</p>
</p>
<div class="pd3">
</div>
