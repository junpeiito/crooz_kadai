...
//$row_id = mysql_fetch_assoc($query);
	...
	$bangou = $_GET['number'];
	//print($bangou);
	$query = mysql_query('select * from kaihatsu where id = "'.$bangou.'"');
	$kaihatsurow = mysql_fetch_assoc($query);
...
<div id="main">
<a name="s1" id="s1"></a>
<h3><?php print($kaihatsurow['title']); ?></h3>
<div class="pd3">
 <br>
 <?php
 $count = 1;
 $movie_array = mysql_query('select * from kaihatsu_movie where kaihatsu_id = "'.$bangou.'" order by id');
