...
mysql_query('delete from kaihatsu where user = "'.$_SESSION['user']['id'].'" and id = "'.$bangou.'"');
mysql_query('delete from kaihatsu_movie where user = "'.$_SESSION['user']['id'].'" and kaihatsu_id = "'.$bangou.'"');
?>削除しました。
