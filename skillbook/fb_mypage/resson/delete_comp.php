...
mysql_query('delete from resson where user = "'.$_SESSION['user']['id'].'" and id = "'.$bangou.'"');
mysql_query('delete from resson_movie where user = "'.$_SESSION['user']['id'].'" and resson_id = "'.$bangou.'"');
?>削除しました。
