...
<title><? print($movie_row['movie_title']); ?>｜視聴</title>
...
<div id="main">
<a name="s1" id="s1"></a>
<h3><? print($movie_row['movie_title']); ?></h3>
<p class="lefttxt1">
<video src="../../fb_mypage/upload/<? print($movie_row['movie_pass']); ?>" controls width=680 height=500 />
</p>
<div class="pd3">
</div>
...
<h3>解説</h3>
<div class="pd3">
 <p class="lefttxt1"><? print($movie_row['info']); ?></p>
...
<h3>最近公開した動画</h3>
<div class="pd3">
 <p class="lefttxt1"><br>・資料1：<? print($movie_row['file_name1']); ?><a href="<? print($movie_row['file_pass1']); ?>">ダウンロード</a>
 <br>・資料2：<? print($movie_row['file_name2']); ?><a href="<? print($movie_row['file_pass2']); ?>">ダウンロード</a>
 <br>・資料3：<? print($movie_row['file_name3']); ?><a href="<? print($movie_row['file_pass3']); ?>">ダウンロード</a></p>
 <p class="right"><img src="../images/img4.jpg" alt="" /></p>
</div>
